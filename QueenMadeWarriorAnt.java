 ...
 * @version 0.0
 */
public class QueenMadeWarriorAnt extends WarriorAnt
{
    private Location targetLoc;
    public QueenMadeWarriorAnt(Location startingLoc, Location targetLoc)
    {
        super(startingLoc);
