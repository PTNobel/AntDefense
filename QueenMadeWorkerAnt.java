 ...
 * @version 0.0
 */
public class QueenMadeWorkerAnt extends WorkerAnt
{
    private Location targetLoc;
    public QueenMadeWorkerAnt(Location startingLoc, Location targetLoc)
    {
        super(startingLoc);
